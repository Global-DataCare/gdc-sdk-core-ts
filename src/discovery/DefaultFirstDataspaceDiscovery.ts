...
import { createDataspaceDiscoveryDefaultsRegistry } from 'gdc-common-utils-ts/utils/dataspace-discovery-defaults';
import type {
  DataspaceDiscoveryDefaultsRegistrySeed,
} from 'gdc-common-utils-ts/models/dataspace-discovery-defaults';
import type { DataspaceDiscoveryDefaultsRegistry } from 'gdc-common-utils-ts/utils/dataspace-discovery-defaults';
import type {
  HostingOperatorSemanticRecord,
  PublishedProviderCatalogRecord,
} from 'gdc-common-utils-ts/models/dataspace-discovery';
import { inferCoverageScopeFromCountryCode } from 'gdc-common-utils-ts/utils/dataspace-discovery';
import { isProviderServiceCapability, ServiceCapabilityToken } from 'gdc-common-utils-ts/constants/service-capabilities';
import { normalizeCountryCode } from 'gdc-common-utils-ts/constants/eu-countries';
import { DataspaceProtocolVersions } from 'gdc-common-utils-ts/constants/dataspace-protocol';
import { DataspaceDiscoverySourceMode } from 'gdc-common-utils-ts/constants/dataspace-discovery';
import { DataspaceCoverageScope } from 'gdc-common-utils-ts/models/dataspace-discovery';
