...
export const ActorFacadeMethods = Object.freeze({
  ...
  registerBlockchainArtifactAndUpdateIndex: 'registerBlockchainArtifactAndUpdateIndex',
  requestClinicalSummary: 'requestClinicalSummary',
  submitVitalSignBatchCommunicationFromSearchResponse: 'submitVitalSignBatchCommunicationFromSearchResponse',
...
const actorFacadeSurfaceMatrix: Record<ActorKind, readonly ActorFacadeMethod[]> = {
  ...
  [ActorKinds.IndividualController]: [
    ...
    ActorFacadeMethods.getSubjectVC,
    ...
    ActorFacadeMethods.registerBlockchainArtifactAndUpdateIndex,
    ActorFacadeMethods.submitVitalSignBatchCommunicationFromSearchResponse,
    ActorFacadeMethods.listLicenses,
    ...
    ActorFacadeMethods.requestSmartToken,
    ActorFacadeMethods.requestClinicalSummary,
