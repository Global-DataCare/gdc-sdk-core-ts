...
import { DataspaceProtocolVersions, DataspaceWellKnownPaths } from 'gdc-common-utils-ts/constants/dataspace-protocol';
import type {
...
import type { DspaceVersionMetadata } from 'gdc-common-utils-ts/models/dataspace-protocol';
import { deriveGwCatalogArtifactUrlFromDspaceVersion } from 'gdc-common-utils-ts/utils/dataspace-protocol';
import { DataspaceCoverageScope } from 'gdc-common-utils-ts/models/dataspace-discovery';
import { isProviderServiceCapability } from 'gdc-common-utils-ts/constants/service-capabilities';
...
/**
 * Runtime-neutral HTTP resolver that combines preloaded hosting-operator
 * records with each host's public service-autodiscovery catalog.
 */
export class HttpDataspaceResolver extends DataspaceResolver {
   ...
   *
   * Resolution order:
   * - canonical DSP entrypoint via `discoveryUrl`
