...
import type { DataspaceDiscoveryDefaultsRegistrySeed } from 'gdc-common-utils-ts/models/dataspace-discovery-defaults';
...
/**
 * Preloaded semantic hosting-operator record used by the runtime to resolve
 * public discovery data without re-parsing VCs.
 */
export type PreloadedHostingOperatorRecord = Readonly<{
  operatorDid: string;
  /**
   * Canonical host DSP discovery entrypoint.
   *
...
/**
 * Normalized hosting-operator match returned by a resolver.
 */
...
/**
 * Normalized published-provider match returned by a resolver.
 */
